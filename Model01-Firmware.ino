...
KEYMAPS(
  ...
  [NORMAN] = KEYMAP_STACKED
             (___,  M(OUTPUT_HID_SPECTRUM),   ___, ___, ___,      ___,      LCTRL(Key_X),
...
void setup() {
  ...
  //SimulatorRecorder.setFirmwareId(PSTR("this is the firmware version"));
...
const macro_t *macroAction(uint8_t macroIndex, uint8_t keyState) {
  ...
  case MACRO_FILE_SEARCH:
    ...
    tapKey(Key_Enter);
    break;
  case OUTPUT_HID_SPECTRUM:
   {
      if(keyToggledOff(keyState)) {
//       Focus.send("Modifiers\n");
//          Serial.flush();
//       for(uint8_t i = 0; i < 8; ++i) {
//          Focus.send(i);
//          Serial.flush();
//          delay(100);
//          bitSet(Keyboard.keyReport.modifiers, i);
//          Keyboard.sendReport();
//          delay(100);
//          bitClear(Keyboard.keyReport.modifiers, i);
//          Keyboard.sendReport();
//          delay(100);
//       }
//       
...
//          delay(100);
//             
//             bitSet(Keyboard.keyReport.keys[j], i);
//             Keyboard.sendReport();
//          delay(100);
//             bitClear(Keyboard.keyReport.keys[j], i);
//             Keyboard.sendReport();
//          delay(100);
//          }
//       }
//       }
//          bitSet(Keyboard.keyReport.keys[14], 4);
//          Keyboard.sendReport();
//          bitClear(Keyboard.keyReport.keys[14], 4);
//          Keyboard.sendReport();
//          
//          uint8_t j = 16;
